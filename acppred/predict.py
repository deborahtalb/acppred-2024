...
def predict_anticancer_peptide(peptide, model:str='data/models/model.pickle') -> float: 
    
    """
    Predicts the probability of anticancer acitivity for an input peptide 
    ...
    - probability (float): probobability of anticancer activity. 
