...
#Classes são especificações de atributos e métodos (funções dentro de classes)
...
#Modelos diferentes que são objetos de uma mesma classe (model). 

rf_model = Model(estimator='random_forest')
